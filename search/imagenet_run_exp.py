...
if __name__ == '__main__':
    ...
    if os.path.isfile(net_config_path):
        ...
        if 'proxyless' in args.net:
            ...
            net_config_url = 'https://hanlab.mit.edu/files/proxylessNAS/%s.config' % args.net  #你自己的网络配置
            net = proxyless_base(
    ...
    if args.resume:
        ...
        pretrained_weight_url = 'https://hanlab.mit.edu/files/proxylessNAS/%s.pth' % args.net  #你自己的模型地址
